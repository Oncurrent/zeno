(ns com.oncurrent.zeno.client.macro-impl
  (:require
...
(defn make-outer-body [sub-map props-sym fq-name inner-component-name]
  `(let [body-fn# (com.oncurrent.zeno.client.react/get* ~props-sym "body-fn")
         zc# (com.oncurrent.zeno.client.react/get* ~props-sym "zc")
         sub-map# (com.oncurrent.zeno.client.react/get* ~props-sym "sub-map")
         resolution-map# (com.oncurrent.zeno.client.react/get* ~props-sym
                                                           "resolution-map")
         [instance-name# _#] (com.oncurrent.zeno.client.react/use-state
                              (str ~fq-name "-" (next-instance-num! zc#)))
         parents# (com.oncurrent.zeno.client.react/get* ~props-sym "parents")
         zeno-state# (com.oncurrent.zeno.client.react/use-zeno-state
                      zc# sub-map# instance-name# resolution-map# parents#)
         inner-props# (com.oncurrent.zeno.client.react/js-obj*
                       ["body-fn" body-fn#
                        "zeno-state" zeno-state#
                        "parents" (conj parents# instance-name#)])]
     (when (and zeno-state# (not= :zeno/unknown zeno-state#))
       (com.oncurrent.zeno.client.react/create-element
        ~inner-component-name inner-props#))))

(defn make-inner-body [props-sym fq-name]
  `(let [body-fn# (com.oncurrent.zeno.client.react/get* ~props-sym "body-fn")
         zeno-state# (com.oncurrent.zeno.client.react/get* ~props-sym "zeno-state")
         parents# (com.oncurrent.zeno.client.react/get* ~props-sym "parents")]
     (binding [com.oncurrent.zeno.client.react/*parents* parents#]
       (body-fn# zeno-state#))))
   ...
   (let [fq-name (str ns-name "/" component-name)
         ...
         c-form `(~@first-line
                  ...
                  (let [~@destructured
                        ...
                        props# (com.oncurrent.zeno.client.react/js-obj*
                                ["body-fn" body-fn#
                                 "zc" ~zc-sym
                                 "sub-map" '~sub-map
                                 "resolution-map" resolution-map#
                                 "parents" com.oncurrent.zeno.client.react/*parents*])]
                    (com.oncurrent.zeno.client.react/create-element
                     ~(if sub-map
