...
(deftest test-insert-after
  (let [state [:a :b]
        path [:zeno/client -1]
        arg :new
        ret (commands/insert* state path :zeno/client :zeno/insert-after arg)
...
(deftest test-insert-before
  (let [state [:a :b]
        path [:zeno/client -1]
        arg :new
        ret (commands/insert* state path :zeno/client :zeno/insert-before arg)
...
(deftest test-bad-insert*-path
  (is (thrown-with-msg?
       ...
       (commands/insert* [] [] :zeno/client :zeno/insert-before :new))))
...
(deftest test-math-no-prefix
  (let [state0 {:a 10}
        state1 {:x {:a 10}}
        state2 {:x [{:a 10} {:a 20}]}
        cases [[{:a 11} state0 {:zeno/path [:a] :zeno/op :zeno/+ :zeno/arg 1}]
               [{:a 9} state0 {:zeno/path [:a] :zeno/op :zeno/- :zeno/arg 1}]
               [{:a 20} state0 {:zeno/path [:a] :zeno/op :zeno/* :zeno/arg 2}]
               [{:a 5} state0 {:zeno/path [:a] :zeno/op :zeno// :zeno/arg 2}]
               [{:a 1} state0 {:zeno/path [:a] :zeno/op :zeno/mod :zeno/arg 3}]
               [{:x {:a 11}} state1 {:zeno/path [:x :a] :zeno/op :zeno/+ :zeno/arg 1}]
               [{:x {:a 9}} state1 {:zeno/path [:x :a] :zeno/op :zeno/- :zeno/arg 1}]
               [{:x {:a 30}} state1 {:zeno/path [:x :a] :zeno/op :zeno/* :zeno/arg 3}]
               [{:x {:a (/ 10 3)}} state1 {:zeno/path [:x :a] :zeno/op :zeno// :zeno/arg 3}]
               [{:x {:a 1}} state1 {:zeno/path [:x :a] :zeno/op :zeno/mod :zeno/arg 3}]
               [{:x [{:a 10} {:a 21}]} state2 {:zeno/path [:x 1 :a] :zeno/op :zeno/+ :zeno/arg 1}]
               [{:x [{:a 10} {:a 19}]} state2 {:zeno/path [:x 1 :a] :zeno/op :zeno/- :zeno/arg 1}]]]
    (doseq [case cases]
...
(deftest test-math-local-prefix
  (let [state0 {:a 10}
        state1 {:x {:a 10}}
        state2 {:x [{:a 10} {:a 20}]}
        cases [[{:a 11} state0 {:zeno/path [:zeno/client :a] :zeno/op :zeno/+ :zeno/arg 1}]
               [{:a 9} state0 {:zeno/path [:zeno/client :a] :zeno/op :zeno/- :zeno/arg 1}]
               [{:a 20} state0 {:zeno/path [:zeno/client :a] :zeno/op :zeno/* :zeno/arg 2}]
               [{:a 5} state0 {:zeno/path [:zeno/client :a] :zeno/op :zeno// :zeno/arg 2}]
               [{:a 1} state0 {:zeno/path [:zeno/client :a] :zeno/op :zeno/mod :zeno/arg 3}]
               [{:x {:a 11}} state1 {:zeno/path [:zeno/client :x :a] :zeno/op :zeno/+ :zeno/arg 1}]
               [{:x {:a 9}} state1 {:zeno/path [:zeno/client :x :a] :zeno/op :zeno/- :zeno/arg 1}]
               [{:x {:a 30}} state1 {:zeno/path [:zeno/client :x :a] :zeno/op :zeno/* :zeno/arg 3}]
               [{:x {:a (/ 10 3)}} state1 {:zeno/path [:zeno/client :x :a] :zeno/op :zeno// :zeno/arg 3}]
               [{:x {:a 1}} state1 {:zeno/path [:zeno/client :x :a] :zeno/op :zeno/mod :zeno/arg 3}]
               [{:x [{:a 10} {:a 21}]} state2 {:zeno/path [:zeno/client :x 1 :a] :zeno/op :zeno/+ :zeno/arg 1}]
               [{:x [{:a 10} {:a 19}]} state2 {:zeno/path [:zeno/client :x 1 :a] :zeno/op :zeno/- :zeno/arg 1}]]]
    (doseq [case cases]
      (let [[expected state* cmd] case
